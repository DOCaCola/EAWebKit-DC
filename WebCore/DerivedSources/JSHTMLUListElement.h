...
public:
    ...
    using DOMWrapped = HTMLUListElement;
...
template<> struct JSDOMWrapperConverterTraits<HTMLUListElement> {
    using WrapperClass = JSHTMLUListElement;
    using ToWrappedReturnType = HTMLUListElement*;
};
