...
public:
    ...
    {
        JSHTMLProgressElement* ptr = new (NotNull, JSC::allocateCell<JSHTMLProgressElement>(globalObject->vm().heap)) JSHTMLProgressElement(structure, *globalObject, WTFMove(impl));
