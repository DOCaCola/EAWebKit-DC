...
bool JSDatabaseCallback::handleEvent(Database* database)
{
    ...
    Ref<JSDatabaseCallback> protectedThis(*this);

    JSLockHolder lock(m_data->globalObject()->vm());

    ExecState* state = m_data->globalObject()->globalExec();
    MarkedArgumentBuffer args;
    args.append(toJS<IDLInterface<Database>>(*state, *m_data->globalObject(), database));
...
JSC::JSValue toJS(DatabaseCallback& impl)
{
    if (!static_cast<JSDatabaseCallback&>(impl).callbackData())
        return jsNull();
