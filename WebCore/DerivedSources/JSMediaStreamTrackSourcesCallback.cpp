...
JSMediaStreamTrackSourcesCallback::~JSMediaStreamTrackSourcesCallback()
{
...
bool JSMediaStreamTrackSourcesCallback::handleEvent(Vector<RefPtr<SourceInfo>> sources)
{
    if (!canInvokeCallback())
        return true;

    Ref<JSMediaStreamTrackSourcesCallback> protect(*this);
