...
JSC::JSValue toJS(JSC::ExecState*, JSDOMGlobalObject*, DatabaseCallback*);
inline JSC::JSValue toJS(JSC::ExecState* state, JSDOMGlobalObject* globalObject, DatabaseCallback& impl) { return toJS(state, globalObject, &impl); }
