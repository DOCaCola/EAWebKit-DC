...
#ifndef JSUserMessageHandlersNamespace_h
#define JSUserMessageHandlersNamespace_h
...
public:
    ...
    static UserMessageHandlersNamespace* toWrapped(JSC::JSValue);
...
class JSUserMessageHandlersNamespaceOwner : public JSC::WeakHandleOwner {
public:
