...
public:
    using Base = JSNode;
    using DOMWrapped = CharacterData;
...
template<> struct JSDOMWrapperConverterTraits<CharacterData> {
    using WrapperClass = JSCharacterData;
    using ToWrappedReturnType = CharacterData*;
};
