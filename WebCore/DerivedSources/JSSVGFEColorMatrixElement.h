...
public:
    ...
    using DOMWrapped = SVGFEColorMatrixElement;
    ...
    {
        JSSVGFEColorMatrixElement* ptr = new (NotNull, JSC::allocateCell<JSSVGFEColorMatrixElement>(globalObject->vm().heap)) JSSVGFEColorMatrixElement(structure, *globalObject, WTFMove(impl));
...
template<> struct JSDOMWrapperConverterTraits<SVGFEColorMatrixElement> {
    using WrapperClass = JSSVGFEColorMatrixElement;
    using ToWrappedReturnType = SVGFEColorMatrixElement*;
};
