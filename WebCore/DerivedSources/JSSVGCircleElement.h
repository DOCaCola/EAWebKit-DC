...
public:
    ...
    using DOMWrapped = SVGCircleElement;
    static JSSVGCircleElement* create(JSC::Structure* structure, JSDOMGlobalObject* globalObject, Ref<SVGCircleElement>&& impl)
    {
        JSSVGCircleElement* ptr = new (NotNull, JSC::allocateCell<JSSVGCircleElement>(globalObject->vm().heap)) JSSVGCircleElement(structure, *globalObject, WTFMove(impl));
...
template<> struct JSDOMWrapperConverterTraits<SVGCircleElement> {
    using WrapperClass = JSSVGCircleElement;
    using ToWrappedReturnType = SVGCircleElement*;
};
