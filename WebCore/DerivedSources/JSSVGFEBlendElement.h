...
public:
    ...
    using DOMWrapped = SVGFEBlendElement;
    static JSSVGFEBlendElement* create(JSC::Structure* structure, JSDOMGlobalObject* globalObject, Ref<SVGFEBlendElement>&& impl)
    {
        JSSVGFEBlendElement* ptr = new (NotNull, JSC::allocateCell<JSSVGFEBlendElement>(globalObject->vm().heap)) JSSVGFEBlendElement(structure, *globalObject, WTFMove(impl));
...
template<> struct JSDOMWrapperConverterTraits<SVGFEBlendElement> {
    using WrapperClass = JSSVGFEBlendElement;
    using ToWrappedReturnType = SVGFEBlendElement*;
};
