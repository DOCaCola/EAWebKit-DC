...
using JSReadableStreamDefaultControllerConstructor = JSDOMConstructor<JSReadableStreamDefaultController>;
...
template<> inline JSReadableStreamDefaultController* BindingCaller<JSReadableStreamDefaultController>::castForAttribute(ExecState&, EncodedJSValue thisValue)
{
    return jsDynamicDowncast<JSReadableStreamDefaultController*>(JSValue::decode(thisValue));
}

template<> inline JSReadableStreamDefaultController* BindingCaller<JSReadableStreamDefaultController>::castForOperation(ExecState& state)
{
    return jsDynamicDowncast<JSReadableStreamDefaultController*>(state.thisValue());
}
...
EncodedJSValue jsReadableStreamDefaultControllerConstructor(ExecState* state, EncodedJSValue thisValue, PropertyName)
{
    ...
    JSReadableStreamDefaultControllerPrototype* domObject = jsDynamicDowncast<JSReadableStreamDefaultControllerPrototype*>(JSValue::decode(thisValue));
