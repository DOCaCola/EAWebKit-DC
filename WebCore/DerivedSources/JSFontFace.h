...
public:
    ...
    static FontFace* toWrapped(JSC::JSValue);
    ...
    mutable JSC::WriteBarrier<JSC::Unknown> m_loaded;
    static void visitChildren(JSCell*, JSC::SlotVisitor&);


    // Custom attributes
    JSC::JSValue loaded(JSC::ExecState&) const;

    // Custom functions
    JSC::JSValue load(JSC::ExecState&);
protected:
...
template<> std::optional<FontFace::LoadStatus> parseEnumeration<FontFace::LoadStatus>(JSC::ExecState&, JSC::JSValue);
template<> FontFace::LoadStatus convertEnumeration<FontFace::LoadStatus>(JSC::ExecState&, JSC::JSValue);
