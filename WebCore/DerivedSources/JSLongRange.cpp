...
template<> LongRange convertDictionary<LongRange>(ExecState& state, JSValue value)
{
    VM& vm = state.vm();
...
JSC::JSObject* convertDictionaryToJS(JSC::ExecState& state, JSDOMGlobalObject& globalObject, const LongRange& dictionary)
{
    auto& vm = state.vm();
