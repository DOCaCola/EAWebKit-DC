...
public:
    ...
    {
        JSReadableByteStreamController* ptr = new (NotNull, JSC::allocateCell<JSReadableByteStreamController>(globalObject->vm().heap)) JSReadableByteStreamController(structure, *globalObject);
...
// Custom constructor
JSC::EncodedJSValue JSC_HOST_CALL constructJSReadableByteStreamController(JSC::ExecState&);
