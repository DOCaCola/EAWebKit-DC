...
public:
    ...
    using DOMWrapped = SVGFESpecularLightingElement;
    ...
    {
        JSSVGFESpecularLightingElement* ptr = new (NotNull, JSC::allocateCell<JSSVGFESpecularLightingElement>(globalObject->vm().heap)) JSSVGFESpecularLightingElement(structure, *globalObject, WTFMove(impl));
...
template<> struct JSDOMWrapperConverterTraits<SVGFESpecularLightingElement> {
    using WrapperClass = JSSVGFESpecularLightingElement;
    using ToWrappedReturnType = SVGFESpecularLightingElement*;
};
