...
#ifndef JSUserMessageHandler_h
#define JSUserMessageHandler_h
...
class JSUserMessageHandlerOwner : public JSC::WeakHandleOwner {
public:
    virtual bool isReachableFromOpaqueRoots(JSC::Handle<JSC::Unknown>, void* context, JSC::SlotVisitor&);
    virtual void finalize(JSC::Handle<JSC::Unknown>, void* context);
};

inline JSC::WeakHandleOwner* wrapperOwner(DOMWrapperWorld&, UserMessageHandler*)
{
    static NeverDestroyed<JSUserMessageHandlerOwner> owner;
    return &owner.get();
}
