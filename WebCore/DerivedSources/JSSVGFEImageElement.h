...
public:
    ...
    using DOMWrapped = SVGFEImageElement;
    static JSSVGFEImageElement* create(JSC::Structure* structure, JSDOMGlobalObject* globalObject, Ref<SVGFEImageElement>&& impl)
    {
        JSSVGFEImageElement* ptr = new (NotNull, JSC::allocateCell<JSSVGFEImageElement>(globalObject->vm().heap)) JSSVGFEImageElement(structure, *globalObject, WTFMove(impl));
...
template<> struct JSDOMWrapperConverterTraits<SVGFEImageElement> {
    using WrapperClass = JSSVGFEImageElement;
    using ToWrappedReturnType = SVGFEImageElement*;
};
