...
class JSIntersectionObserverCallback : public IntersectionObserverCallback, public ActiveDOMCallback {
public:
    ...
    virtual ~JSIntersectionObserverCallback();
    JSCallbackDataStrong* callbackData() { return m_data; }

    // Functions
    virtual bool handleEvent(Vector<RefPtr<IntersectionObserverEntry>> entries, IntersectionObserver* observer);
