...
public:
    ...
    {
        JSSVGPathSegLinetoAbs* ptr = new (NotNull, JSC::allocateCell<JSSVGPathSegLinetoAbs>(globalObject->vm().heap)) JSSVGPathSegLinetoAbs(structure, globalObject, WTF::move(impl));
