...
template<> const ClassInfo JSOfflineAudioContextConstructor::s_info = { "webkitOfflineAudioContextConstructor", &Base::s_info, 0, CREATE_METHOD_TABLE(JSOfflineAudioContextConstructor) };
...
EncodedJSValue jsOfflineAudioContextConstructor(ExecState* state, JSObject* baseValue, EncodedJSValue, PropertyName)
{
