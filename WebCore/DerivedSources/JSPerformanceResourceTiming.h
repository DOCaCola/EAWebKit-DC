...
public:
    ...
    {
        JSPerformanceResourceTiming* ptr = new (NotNull, JSC::allocateCell<JSPerformanceResourceTiming>(globalObject->vm().heap)) JSPerformanceResourceTiming(structure, *globalObject, WTF::move(impl));
