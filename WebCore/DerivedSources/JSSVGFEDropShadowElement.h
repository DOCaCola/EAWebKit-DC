...
public:
    ...
    using DOMWrapped = SVGFEDropShadowElement;
    ...
    {
        JSSVGFEDropShadowElement* ptr = new (NotNull, JSC::allocateCell<JSSVGFEDropShadowElement>(globalObject->vm().heap)) JSSVGFEDropShadowElement(structure, *globalObject, WTFMove(impl));
...
template<> struct JSDOMWrapperConverterTraits<SVGFEDropShadowElement> {
    using WrapperClass = JSSVGFEDropShadowElement;
    using ToWrappedReturnType = SVGFEDropShadowElement*;
};
