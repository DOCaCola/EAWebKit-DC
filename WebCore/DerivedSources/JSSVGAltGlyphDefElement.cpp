...
template<> const ClassInfo JSSVGAltGlyphDefElementConstructor::s_info = { "SVGAltGlyphDefElementConstructor", &Base::s_info, 0, CREATE_METHOD_TABLE(JSSVGAltGlyphDefElementConstructor) };
...
EncodedJSValue jsSVGAltGlyphDefElementConstructor(ExecState* state, JSObject* baseValue, EncodedJSValue, PropertyName)
{
