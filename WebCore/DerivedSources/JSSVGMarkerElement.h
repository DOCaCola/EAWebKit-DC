...
public:
    ...
    using DOMWrapped = SVGMarkerElement;
    static JSSVGMarkerElement* create(JSC::Structure* structure, JSDOMGlobalObject* globalObject, Ref<SVGMarkerElement>&& impl)
    {
        JSSVGMarkerElement* ptr = new (NotNull, JSC::allocateCell<JSSVGMarkerElement>(globalObject->vm().heap)) JSSVGMarkerElement(structure, *globalObject, WTFMove(impl));
...
template<> struct JSDOMWrapperConverterTraits<SVGMarkerElement> {
    using WrapperClass = JSSVGMarkerElement;
    using ToWrappedReturnType = SVGMarkerElement*;
};
