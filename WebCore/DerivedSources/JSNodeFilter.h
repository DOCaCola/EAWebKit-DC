...
public:
    ...
    // Functions
    virtual uint16_t acceptNode(Node* n);
...
inline JSC::JSValue toJS(JSC::ExecState* state, JSDOMGlobalObject* globalObject, NodeFilter& impl) { return toJS(state, globalObject, &impl); }
