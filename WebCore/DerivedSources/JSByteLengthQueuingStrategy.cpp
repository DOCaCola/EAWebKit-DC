...
using JSByteLengthQueuingStrategyConstructor = JSBuiltinConstructor<JSByteLengthQueuingStrategy>;
...
template<> inline JSByteLengthQueuingStrategy* BindingCaller<JSByteLengthQueuingStrategy>::castForOperation(ExecState& state)
{
    return jsDynamicDowncast<JSByteLengthQueuingStrategy*>(state.thisValue());
}
...
EncodedJSValue jsByteLengthQueuingStrategyConstructor(ExecState* state, EncodedJSValue thisValue, PropertyName)
{
    ...
    JSByteLengthQueuingStrategyPrototype* domObject = jsDynamicDowncast<JSByteLengthQueuingStrategyPrototype*>(JSValue::decode(thisValue));
