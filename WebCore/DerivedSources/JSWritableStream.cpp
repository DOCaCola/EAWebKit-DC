...
using JSWritableStreamConstructor = JSBuiltinConstructor<JSWritableStream>;
...
template<> inline JSWritableStream* BindingCaller<JSWritableStream>::castForAttribute(ExecState&, EncodedJSValue thisValue)
{
    return jsDynamicDowncast<JSWritableStream*>(JSValue::decode(thisValue));
}

template<> inline JSWritableStream* BindingCaller<JSWritableStream>::castForOperation(ExecState& state)
{
    return jsDynamicDowncast<JSWritableStream*>(state.thisValue());
}
...
EncodedJSValue jsWritableStreamConstructor(ExecState* state, EncodedJSValue thisValue, PropertyName)
{
    ...
    JSWritableStreamPrototype* domObject = jsDynamicDowncast<JSWritableStreamPrototype*>(JSValue::decode(thisValue));
