...
#ifndef JSRTCSessionDescriptionCallback_h
#define JSRTCSessionDescriptionCallback_h
...
public:
    ...
    virtual ~JSRTCSessionDescriptionCallback();

    // Functions
    virtual bool handleEvent(RTCSessionDescription* sdp);

private:
    JSRTCSessionDescriptionCallback(JSC::JSObject* callback, JSDOMGlobalObject*);
