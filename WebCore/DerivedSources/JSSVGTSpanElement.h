...
public:
    ...
    using DOMWrapped = SVGTSpanElement;
    static JSSVGTSpanElement* create(JSC::Structure* structure, JSDOMGlobalObject* globalObject, Ref<SVGTSpanElement>&& impl)
    {
        JSSVGTSpanElement* ptr = new (NotNull, JSC::allocateCell<JSSVGTSpanElement>(globalObject->vm().heap)) JSSVGTSpanElement(structure, *globalObject, WTFMove(impl));
...
template<> struct JSDOMWrapperConverterTraits<SVGTSpanElement> {
    using WrapperClass = JSSVGTSpanElement;
    using ToWrappedReturnType = SVGTSpanElement*;
};
