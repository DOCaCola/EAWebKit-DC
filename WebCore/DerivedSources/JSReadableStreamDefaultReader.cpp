...
using JSReadableStreamDefaultReaderConstructor = JSDOMConstructor<JSReadableStreamDefaultReader>;
...
template<> inline JSReadableStreamDefaultReader* BindingCaller<JSReadableStreamDefaultReader>::castForAttribute(ExecState&, EncodedJSValue thisValue)
{
    return jsDynamicDowncast<JSReadableStreamDefaultReader*>(JSValue::decode(thisValue));
}

template<> inline JSReadableStreamDefaultReader* BindingCaller<JSReadableStreamDefaultReader>::castForOperation(ExecState& state)
{
    return jsDynamicDowncast<JSReadableStreamDefaultReader*>(state.thisValue());
}
...
EncodedJSValue jsReadableStreamDefaultReaderConstructor(ExecState* state, EncodedJSValue thisValue, PropertyName)
{
    ...
    JSReadableStreamDefaultReaderPrototype* domObject = jsDynamicDowncast<JSReadableStreamDefaultReaderPrototype*>(JSValue::decode(thisValue));
