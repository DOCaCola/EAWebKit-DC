...
public:
    ...
    using DOMWrapped = SVGFECompositeElement;
...
template<> struct JSDOMWrapperConverterTraits<SVGFECompositeElement> {
    using WrapperClass = JSSVGFECompositeElement;
    using ToWrappedReturnType = SVGFECompositeElement*;
};
