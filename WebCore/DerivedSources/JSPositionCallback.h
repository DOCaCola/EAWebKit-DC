...
JSC::JSValue toJS(JSC::ExecState*, JSDOMGlobalObject*, PositionCallback*);
inline JSC::JSValue toJS(JSC::ExecState* state, JSDOMGlobalObject* globalObject, PositionCallback& impl) { return toJS(state, globalObject, &impl); }
