...
public:
    ...
    using DOMWrapped = SVGDescElement;
    static JSSVGDescElement* create(JSC::Structure* structure, JSDOMGlobalObject* globalObject, Ref<SVGDescElement>&& impl)
    {
        JSSVGDescElement* ptr = new (NotNull, JSC::allocateCell<JSSVGDescElement>(globalObject->vm().heap)) JSSVGDescElement(structure, *globalObject, WTFMove(impl));
...
template<> struct JSDOMWrapperConverterTraits<SVGDescElement> {
    using WrapperClass = JSSVGDescElement;
    using ToWrappedReturnType = SVGDescElement*;
};
