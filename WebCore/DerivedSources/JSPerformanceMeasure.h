...
#ifndef JSPerformanceMeasure_h
#define JSPerformanceMeasure_h
...
public:
    ...
    {
        JSPerformanceMeasure* ptr = new (NotNull, JSC::allocateCell<JSPerformanceMeasure>(globalObject->vm().heap)) JSPerformanceMeasure(structure, *globalObject, WTF::move(impl));
