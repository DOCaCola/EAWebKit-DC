...
#ifndef JSStorageQuotaCallback_h
#define JSStorageQuotaCallback_h
...
public:
    ...
    virtual ~JSStorageQuotaCallback();

    // Functions
    virtual bool handleEvent(unsigned long long grantedQuotaInBytes);

private:
    JSStorageQuotaCallback(JSC::JSObject* callback, JSDOMGlobalObject*);
