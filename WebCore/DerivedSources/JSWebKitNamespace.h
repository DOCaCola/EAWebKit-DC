...
#ifndef JSWebKitNamespace_h
#define JSWebKitNamespace_h
...
class JSWebKitNamespaceOwner : public JSC::WeakHandleOwner {
public:
    virtual bool isReachableFromOpaqueRoots(JSC::Handle<JSC::Unknown>, void* context, JSC::SlotVisitor&);
    virtual void finalize(JSC::Handle<JSC::Unknown>, void* context);
};

inline JSC::WeakHandleOwner* wrapperOwner(DOMWrapperWorld&, WebKitNamespace*)
{
    static NeverDestroyed<JSWebKitNamespaceOwner> owner;
    return &owner.get();
}
