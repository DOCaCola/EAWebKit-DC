...
private:
    JSSQLTransactionCallback(JSC::JSObject*, JSDOMGlobalObject*);

    JSCallbackDataStrong* m_data;
};

JSC::JSValue toJS(SQLTransactionCallback&);
inline JSC::JSValue toJS(SQLTransactionCallback* impl) { return impl ? toJS(*impl) : JSC::jsNull(); }
