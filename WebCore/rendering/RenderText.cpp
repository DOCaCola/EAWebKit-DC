...
void RenderText::setRenderedText(const String& text)
{
    ...
    case TSCIRCLE:
        ...
        break;
    case TSDISC:
			//+EAWebKitChange - Added option for user to set password character to use (bullet is default). 
            //7/22/2013
            {
                UChar passwordChar = EA::WebKit::GetParameters().mPasswordMaskCharacter;
                secureText(passwordChar);
            }
            //-EAWebKitChange
        break;
    case TSSQUARE:
