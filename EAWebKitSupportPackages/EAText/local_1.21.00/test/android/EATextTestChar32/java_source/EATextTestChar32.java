...
package com.ea.EATextTestChar32;
...
public class EATextTestChar32 extends Activity{    
Handler handler;
    @Override
    ...
    protected class InitTask extends AsyncTask<Context, Void, Integer>
    {
        ...
        protected Integer doInBackground( Context... params ) {
          ...
          EAIO.Startup(EATextTestChar32.this);
          EAThread.Init();
        
          final int ret = runEntryPoint(fileRoot.getAbsolutePath(), externalRoot.getAbsolutePath() + "/com.ea.EATextTestChar32");
          setResult(ret);
    ...
    static {
        System.loadLibrary("EATextTestChar32");
    }
}
