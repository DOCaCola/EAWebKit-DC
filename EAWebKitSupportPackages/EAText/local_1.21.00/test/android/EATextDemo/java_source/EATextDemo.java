...
public class EATextDemo extends Activity{    
Handler handler;
    @Override
    ...
    protected class InitTask extends AsyncTask<Context, Void, Integer>
    {
        ...
        protected Integer doInBackground( Context... params ) {
          ...
          EAIO.Startup(EATextDemo.this);
          EAThread.Init();
        
          final int ret = runEntryPoint(fileRoot.getAbsolutePath(), externalRoot.getAbsolutePath() + "/com.ea.EATextDemo");
          setResult(ret);
