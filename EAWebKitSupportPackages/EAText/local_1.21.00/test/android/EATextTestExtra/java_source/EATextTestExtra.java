...
package com.ea.EATextTestExtra;
...
public class EATextTestExtra extends Activity{    
Handler handler;
    @Override
    ...
    protected class InitTask extends AsyncTask<Context, Void, Integer>
    {
        ...
        protected Integer doInBackground( Context... params ) {
          ...
          EAIO.Startup(EATextTestExtra.this);
          EAThread.Init();
        
          final int ret = runEntryPoint(fileRoot.getAbsolutePath(), externalRoot.getAbsolutePath() + "/com.ea.EATextTestExtra");
          setResult(ret);
    ...
    static {
        System.loadLibrary("EATextTestExtra");
    }
}
