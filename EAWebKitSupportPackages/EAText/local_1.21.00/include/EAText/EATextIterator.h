...
#if (defined(EA_COMPILER_NO_STANDARD_CPP_LIBRARY) || !EASTL_STD_ITERATOR_CATEGORY_ENABLED) || (EASTL_VERSION_N >= 11303) // EASTL 1.13.03 changed to using eastl iterators unilaterally.
