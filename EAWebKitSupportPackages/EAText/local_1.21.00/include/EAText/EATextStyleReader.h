...
namespace EA
{
	namespace Text
	{
		...
		protected:
			...
			/// NameString
			typedef eastl::fixed_string<char, 12, true, EA::Allocator::EASTLICoreAllocator> NameString;
			typedef eastl::fixed_hash_map< NameString, uint32_t, 15, 16, true, eastl::string_hash<NameString>, eastl::equal_to<NameString>, false, EA::Allocator::EASTLICoreAllocator > tStyleNameMap;
