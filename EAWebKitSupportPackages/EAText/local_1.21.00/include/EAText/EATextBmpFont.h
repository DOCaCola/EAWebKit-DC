...
namespace EA
{
	...
	namespace Text
	{
		...
		typedef eastl::fixed_string<FilePathChar, kPathStringLength + 1, true, EA::Allocator::EASTLICoreAllocator> EATextPathString;
		...
		{
			unsigned mnTextureIndex :  8;  /// Which bitmap/texture this glyph is on.
			unsigned mnPositionX    : 12;  /// The coordinate origin of this bitmap on the texture.
			unsigned mnPositionY    : 12;  /// The coordinate origin of this bitmap on the texture.
		};
		...
		protected:
			...
			typedef eastl::fixed_vector<BmpTextureInfo*, 4, true, EA::Allocator::EASTLICoreAllocator> TextureInfoArray;
