	...
	namespace Text
	{
		...
		public:         
			...
			FT_Stream     mpFTStream;               // Used for providing custom IO for the Face.
				...
				static EA::Thread::Futex mMutex;    // FreeType isn't thread-safe between FT_Face instances and so we must share a mutex between them.
			#endif
		...
		protected:
			...
			int16_t             mDPI;
			ScreenColorType     mScreenColorType;
