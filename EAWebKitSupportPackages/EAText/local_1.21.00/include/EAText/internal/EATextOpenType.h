...
typedef eastl::fixed_vector<OTFTagStruct, 16, true, EA::Allocator::EASTLICoreAllocator> OTFTagStructArray16;
...
typedef eastl::fixed_vector<OTFLookup*, 16, true, EA::Allocator::EASTLICoreAllocator> OTFLookupPtrArray16;
...
typedef eastl::fixed_vector<FeatureLookup, 10, true, EA::Allocator::EASTLICoreAllocator> FeatureLookupArray;
