...
typedef eastl::fixed_vector<uint16_t, 1024, true, EA::Allocator::EASTLICoreAllocator> GlyphBuffer;
typedef eastl::fixed_vector<uint16_t, 1024, true, EA::Allocator::EASTLICoreAllocator> OffsetBuffer;
