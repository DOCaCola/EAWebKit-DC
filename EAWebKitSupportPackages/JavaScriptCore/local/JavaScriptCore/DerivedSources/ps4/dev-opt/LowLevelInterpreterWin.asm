; offlineasm input hash: 94f23e4630190e03b831bc3a08fe5931eaaa1c02 0ab8c2d4edcde5edaaee7d9d7e9d67e2d1ce0190 82fda4e596667d2e1f55992b19f40ba7a9e32fdf
...
_TEXT SEGMENT
  ...
  _llint_vm_entry_to_javascript:
    ...
    *CAST<intptr_t*>(sp.i8p) = t1.i;                         ; ..\..\JavaScriptCore\local\JavaScriptCore\llint/LowLevelInterpreter64.asm:181
    pc.i = *CAST<intptr_t*>(t1.i8p + 10016);                 ; ..\..\JavaScriptCore\local\JavaScriptCore\llint/LowLevelInterpreter64.asm:182
    *CAST<intptr_t*>(sp.i8p + 8) = pc.i;                     ; ..\..\JavaScriptCore\local\JavaScriptCore\llint/LowLevelInterpreter64.asm:183
    pc.i = *CAST<intptr_t*>(t1.i8p + 10008);                 ; ..\..\JavaScriptCore\local\JavaScriptCore\llint/LowLevelInterpreter64.asm:184
    *CAST<intptr_t*>(sp.i8p + 16) = pc.i;                    ; ..\..\JavaScriptCore\local\JavaScriptCore\llint/LowLevelInterpreter64.asm:185
    *CAST<intptr_t*>(t1.i8p + 10008) = cfr.i;                ; ..\..\JavaScriptCore\local\JavaScriptCore\llint/LowLevelInterpreter64.asm:186
    ...
    if (t3.u >= *CAST<uintptr_t*>(t1.i8p + 16848))           ; ..\..\JavaScriptCore\local\JavaScriptCore\llint/LowLevelInterpreter64.asm:196
  ...
  _offlineasm_doVMEntry__stackCheckFailed:
    ...
    *CAST<intptr_t*>(t1.i8p + 10016) = pcBase.i;             ; ..\..\JavaScriptCore\local\JavaScriptCore\llint/LowLevelInterpreter64.asm:218
    pcBase.i = *CAST<intptr_t*>(pc.i8p + 16);                ; ..\..\JavaScriptCore\local\JavaScriptCore\llint/LowLevelInterpreter64.asm:219
    *CAST<intptr_t*>(t1.i8p + 10008) = pcBase.i;             ; ..\..\JavaScriptCore\local\JavaScriptCore\llint/LowLevelInterpreter64.asm:220
  ...
  _offlineasm_doVMEntry__copyArgsDone:
    *CAST<intptr_t*>(t1.i8p + 10016) = sp.i;                 ; ..\..\JavaScriptCore\local\JavaScriptCore\llint/LowLevelInterpreter64.asm:265
  ...
  _llint_cloop_did_return_from_js_1:
    ...
    *CAST<intptr_t*>(t1.i8p + 10016) = pcBase.i;             ; ..\..\JavaScriptCore\local\JavaScriptCore\llint/LowLevelInterpreter64.asm:281
    pcBase.i = *CAST<intptr_t*>(pc.i8p + 16);                ; ..\..\JavaScriptCore\local\JavaScriptCore\llint/LowLevelInterpreter64.asm:282
    *CAST<intptr_t*>(t1.i8p + 10008) = pcBase.i;             ; ..\..\JavaScriptCore\local\JavaScriptCore\llint/LowLevelInterpreter64.asm:283
...
llint_entry PROC PUBLIC
  ...
  _llint_program_prologue:
    ...
    if (*CAST<uintptr_t*>(t2.i8p + 16848) <= t0.u)           ; ..\..\JavaScriptCore\local\JavaScriptCore\llint\LowLevelInterpreter.asm:633
  ...
  _handleUncaughtException:
    ...
    cfr.i = *CAST<intptr_t*>(t3.i8p + 16616);                ; ..\..\JavaScriptCore\local\JavaScriptCore\llint/LowLevelInterpreter64.asm:333
    ...
    *CAST<intptr_t*>(t3.i8p + 10016) = t5.i;                 ; ..\..\JavaScriptCore\local\JavaScriptCore\llint/LowLevelInterpreter64.asm:340
    t5.i = *CAST<intptr_t*>(t2.i8p + 16);                    ; ..\..\JavaScriptCore\local\JavaScriptCore\llint/LowLevelInterpreter64.asm:341
    *CAST<intptr_t*>(t3.i8p + 10008) = t5.i;                 ; ..\..\JavaScriptCore\local\JavaScriptCore\llint/LowLevelInterpreter64.asm:342
  ...
  _llint_op_catch:
    ...
    cfr.i = *CAST<intptr_t*>(t3.i8p + 16616);                ; ..\..\JavaScriptCore\local\JavaScriptCore\llint/LowLevelInterpreter64.asm:1797
    ...
    t5.i = *CAST<intptr_t*>(t3.i8p + 16632);                 ; ..\..\JavaScriptCore\local\JavaScriptCore\llint/LowLevelInterpreter64.asm:1802
    ...
    t0.i64 = *CAST<int64_t*>(t3.i8p + 16864);                ; ..\..\JavaScriptCore\local\JavaScriptCore\llint/LowLevelInterpreter64.asm:1806
    *CAST<int64_t*>(t3.i8p + 16864) = int64_t(0x0);          ; ..\..\JavaScriptCore\local\JavaScriptCore\llint/LowLevelInterpreter64.asm:1807
    t2.i = *CAST<int32_t*>(pcBase.i8p + (t5.i << 3) + intptr_t(0x8)); ; ..\..\JavaScriptCore\local\JavaScriptCore\llint\LowLevelInterpreter.asm:121
  ...
  _llint_throw_from_slow_path_trampoline:
    ...
    opcode = *CAST<Opcode*>(t1.i8p + 16624);                 ; ..\..\JavaScriptCore\local\JavaScriptCore\llint/LowLevelInterpreter64.asm:1837
    DISPATCH_OPCODE();
  ...
  _llint_op_profile_type:
    ...
    t1.i = *CAST<intptr_t*>(t1.i8p + 16968);                 ; ..\..\JavaScriptCore\local\JavaScriptCore\llint/LowLevelInterpreter64.asm:2193
  ...
  _llint_op_loop_hint:
    ...
    t0.i = *CAST<intptr_t*>(t1.i8p + 10024);                 ; ..\..\JavaScriptCore\local\JavaScriptCore\llint\LowLevelInterpreter.asm:1162
  ...
  _llint_op_call_varargs:
    ...
    if (*CAST<int64_t*>(t3.i8p + 16864) == 0)                ; ..\..\JavaScriptCore\local\JavaScriptCore\llint/LowLevelInterpreter64.asm:584
  ...
  _llint_op_profile_will_call:
    ...
    t0.u = *CAST<uint32_t*>(t0.i8p + 16904);                 ; ..\..\JavaScriptCore\local\JavaScriptCore\llint\LowLevelInterpreter.asm:1312
  ...
  _llint_op_profile_did_call:
    ...
    t0.u = *CAST<uint32_t*>(t0.i8p + 16904);                 ; ..\..\JavaScriptCore\local\JavaScriptCore\llint\LowLevelInterpreter.asm:1323
  ...
  _llint_native_call_trampoline:
    ...
    *CAST<intptr_t*>(t1.i8p + 10016) = cfr.i;                ; ..\..\JavaScriptCore\local\JavaScriptCore\llint/LowLevelInterpreter64.asm:1881
    ...
    *CAST<intptr_t*>(cfr.i8p + 8) = t3.i;                    ; ..\..\JavaScriptCore\local\JavaScriptCore\llint/LowLevelInterpreter64.asm:1883
    ...
    POP(cfr);                                                ; ..\..\JavaScriptCore\local\JavaScriptCore\llint\LowLevelInterpreter.asm:446
    POP(lr);                                                 ; ..\..\JavaScriptCore\local\JavaScriptCore\llint\LowLevelInterpreter.asm:447
    if (*CAST<int64_t*>(t3.i8p + 16864) != 0)                ; ..\..\JavaScriptCore\local\JavaScriptCore\llint/LowLevelInterpreter64.asm:1902
  ...
  _offlineasm_nativeCallTrampoline__handleException:
    *CAST<intptr_t*>(t3.i8p + 10016) = cfr.i;                ; ..\..\JavaScriptCore\local\JavaScriptCore\llint/LowLevelInterpreter64.asm:1906
    t2.i = *CAST<intptr_t*>(cfr.i8p + 16);                   ; ..\..\JavaScriptCore\local\JavaScriptCore\llint\LowLevelInterpreter.asm:462
    pc.u = *CAST<uint32_t*>(t2.i8p + 56);                    ; ..\..\JavaScriptCore\local\JavaScriptCore\llint\LowLevelInterpreter.asm:456
    pc.i = pc.i << (intptr_t(0x3) & 0x1f);                   ; ..\..\JavaScriptCore\local\JavaScriptCore\llint\LowLevelInterpreter.asm:457
    pc.i = pc.i + intptr_t(0x0);                             ; ..\..\JavaScriptCore\local\JavaScriptCore\llint\LowLevelInterpreter.asm:458
