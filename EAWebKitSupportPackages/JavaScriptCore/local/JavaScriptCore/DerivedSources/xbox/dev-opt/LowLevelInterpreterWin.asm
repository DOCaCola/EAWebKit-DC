; offlineasm input hash: 94f23e4630190e03b831bc3a08fe5931eaaa1c02 ca3fd26674ab6e9367e16fe0af1e887e2e2b90ea 82fda4e596667d2e1f55992b19f40ba7a9e32fdf
...
_TEXT SEGMENT
  ...
  _llint_vm_entry_to_javascript:
    ...
    *CAST<intptr_t*>(sp.i8p) = t1.i;                         ; ..\..\JavaScriptCore\local\JavaScriptCore\llint/LowLevelInterpreter64.asm:181
    pc.i = *CAST<intptr_t*>(t1.i8p + 9984);                  ; ..\..\JavaScriptCore\local\JavaScriptCore\llint/LowLevelInterpreter64.asm:182
    *CAST<intptr_t*>(sp.i8p + 8) = pc.i;                     ; ..\..\JavaScriptCore\local\JavaScriptCore\llint/LowLevelInterpreter64.asm:183
    pc.i = *CAST<intptr_t*>(t1.i8p + 9976);                  ; ..\..\JavaScriptCore\local\JavaScriptCore\llint/LowLevelInterpreter64.asm:184
    *CAST<intptr_t*>(sp.i8p + 16) = pc.i;                    ; ..\..\JavaScriptCore\local\JavaScriptCore\llint/LowLevelInterpreter64.asm:185
    *CAST<intptr_t*>(t1.i8p + 9976) = cfr.i;                 ; ..\..\JavaScriptCore\local\JavaScriptCore\llint/LowLevelInterpreter64.asm:186
    ...
    if (t3.u >= *CAST<uintptr_t*>(t1.i8p + 16784))           ; ..\..\JavaScriptCore\local\JavaScriptCore\llint/LowLevelInterpreter64.asm:196
  ...
  _offlineasm_doVMEntry__stackCheckFailed:
    ...
    *CAST<intptr_t*>(t1.i8p + 9984) = pcBase.i;              ; ..\..\JavaScriptCore\local\JavaScriptCore\llint/LowLevelInterpreter64.asm:218
    pcBase.i = *CAST<intptr_t*>(pc.i8p + 16);                ; ..\..\JavaScriptCore\local\JavaScriptCore\llint/LowLevelInterpreter64.asm:219
    *CAST<intptr_t*>(t1.i8p + 9976) = pcBase.i;              ; ..\..\JavaScriptCore\local\JavaScriptCore\llint/LowLevelInterpreter64.asm:220
  ...
  _offlineasm_doVMEntry__copyArgsDone:
    *CAST<intptr_t*>(t1.i8p + 9984) = sp.i;                  ; ..\..\JavaScriptCore\local\JavaScriptCore\llint/LowLevelInterpreter64.asm:265
  ...
  _llint_cloop_did_return_from_js_1:
    ...
    *CAST<intptr_t*>(t1.i8p + 9984) = pcBase.i;              ; ..\..\JavaScriptCore\local\JavaScriptCore\llint/LowLevelInterpreter64.asm:281
    pcBase.i = *CAST<intptr_t*>(pc.i8p + 16);                ; ..\..\JavaScriptCore\local\JavaScriptCore\llint/LowLevelInterpreter64.asm:282
    *CAST<intptr_t*>(t1.i8p + 9976) = pcBase.i;              ; ..\..\JavaScriptCore\local\JavaScriptCore\llint/LowLevelInterpreter64.asm:283
...
llint_entry PROC PUBLIC
  ...
  _llint_program_prologue:
    ...
    if (*CAST<uintptr_t*>(t2.i8p + 16784) <= t0.u)           ; ..\..\JavaScriptCore\local\JavaScriptCore\llint\LowLevelInterpreter.asm:633
  ...
  _handleUncaughtException:
    ...
    cfr.i = *CAST<intptr_t*>(t3.i8p + 16560);                ; ..\..\JavaScriptCore\local\JavaScriptCore\llint/LowLevelInterpreter64.asm:333
    ...
    *CAST<intptr_t*>(t3.i8p + 9984) = t5.i;                  ; ..\..\JavaScriptCore\local\JavaScriptCore\llint/LowLevelInterpreter64.asm:340
    t5.i = *CAST<intptr_t*>(t2.i8p + 16);                    ; ..\..\JavaScriptCore\local\JavaScriptCore\llint/LowLevelInterpreter64.asm:341
    *CAST<intptr_t*>(t3.i8p + 9976) = t5.i;                  ; ..\..\JavaScriptCore\local\JavaScriptCore\llint/LowLevelInterpreter64.asm:342
  ...
  _offlineasm_putByIdTransition__loadConstantOrVariableCell__65_loadConstantOrVariable__done:
    ...
    t3.i = *CAST<intptr_t*>(t3.i8p + 8);                     ; ..\..\JavaScriptCore\local\JavaScriptCore\llint/LowLevelInterpreter64.asm:1363
    if (*CAST<int64_t*>(t1.i8p + 32) == int64_t(0x2))        ; ..\..\JavaScriptCore\local\JavaScriptCore\llint/LowLevelInterpreter64.asm:1365
        goto _offlineasm_putByIdTransition__65_additionalChecks__done;

  _offlineasm_putByIdTransition__65_additionalChecks__loop:
    t1.i64 = *CAST<int64_t*>(t1.i8p + 32);                   ; ..\..\JavaScriptCore\local\JavaScriptCore\llint/LowLevelInterpreter64.asm:1367
    t2.u = *CAST<uint32_t*>(t1.i8p);                         ; ..\..\JavaScriptCore\local\JavaScriptCore\llint/LowLevelInterpreter64.asm:506
    t1.i = *CAST<intptr_t*>(cfr.i8p + 16);                   ; ..\..\JavaScriptCore\local\JavaScriptCore\llint/LowLevelInterpreter64.asm:507
    t1.i = *CAST<intptr_t*>(t1.i8p + 96);                    ; ..\..\JavaScriptCore\local\JavaScriptCore\llint/LowLevelInterpreter64.asm:508
    ...
    t3.i = t3.i + intptr_t(0x8);                             ; ..\..\JavaScriptCore\local\JavaScriptCore\llint/LowLevelInterpreter64.asm:1371
    if (*CAST<int64_t*>(t1.i8p + 32) != int64_t(0x2))        ; ..\..\JavaScriptCore\local\JavaScriptCore\llint/LowLevelInterpreter64.asm:1372
        goto _offlineasm_putByIdTransition__65_additionalChecks__loop;

  _offlineasm_putByIdTransition__65_additionalChecks__done:
    t2.i = *CAST<int32_t*>(pcBase.i8p + (t5.i << 3) + intptr_t(0x18)); ; ..\..\JavaScriptCore\local\JavaScriptCore\llint\LowLevelInterpreter.asm:121
    t1.i = *CAST<int32_t*>(pcBase.i8p + (t5.i << 3) + intptr_t(0x28)); ; ..\..\JavaScriptCore\local\JavaScriptCore\llint\LowLevelInterpreter.asm:121
    t3.i = *CAST<intptr_t*>(t0.i8p + 8);                     ; ..\..\JavaScriptCore\local\JavaScriptCore\llint\LowLevelInterpreter.asm:1036
    t3.i = t1.i + t3.i;                                      ; ..\..\JavaScriptCore\local\JavaScriptCore\llint/LowLevelInterpreter64.asm:1346
  ...
  _llint_op_jneq_null:
    ...
    t0.i64 = *CAST<int64_t*>(cfr.i8p + (t0.i << 3));         ; ..\..\JavaScriptCore\local\JavaScriptCore\llint/LowLevelInterpreter64.asm:1565
    if ((t0.i64 & tagMask.i64) != 0)                         ; ..\..\JavaScriptCore\local\JavaScriptCore\llint/LowLevelInterpreter64.asm:1566
        goto _offlineasm_84_equalNull__immediate;
    t1.i = *CAST<intptr_t*>(cfr.i8p + 16);                   ; ..\..\JavaScriptCore\local\JavaScriptCore\llint/LowLevelInterpreter64.asm:498
    t1.i = *CAST<intptr_t*>(t1.i8p + 96);                    ; ..\..\JavaScriptCore\local\JavaScriptCore\llint/LowLevelInterpreter64.asm:499
    t1.i = *CAST<intptr_t*>(t1.i8p + 168);                   ; ..\..\JavaScriptCore\local\JavaScriptCore\llint/LowLevelInterpreter64.asm:500
    t2.u = *CAST<uint32_t*>(t0.i8p);                         ; ..\..\JavaScriptCore\local\JavaScriptCore\llint/LowLevelInterpreter64.asm:501
    ...
    if ((*CAST<int8_t*>(t0.i8p + 6) & int8_t(0x1)) == 0)     ; ..\..\JavaScriptCore\local\JavaScriptCore\llint/LowLevelInterpreter64.asm:1597
        goto _offlineasm_84_equalNull__target;
  ...
  _offlineasm_84_equalNull__target:
    t5.i32 = t5.i32 + *CAST<int32_t*>(pcBase.i8p + (t5.i << 3) + intptr_t(0x10)); ; ..\..\JavaScriptCore\local\JavaScriptCore\llint/LowLevelInterpreter64.asm:36
    t5.clearHighWord();
    opcode = *CAST<Opcode*>(pcBase.i8p + (t5.i << 3));       ; ..\..\JavaScriptCore\local\JavaScriptCore\llint/LowLevelInterpreter64.asm:27
    DISPATCH_OPCODE();

  _offlineasm_84_equalNull__immediate:
    t0.i64 = t0.i64 & int64_t(-9);                           ; ..\..\JavaScriptCore\local\JavaScriptCore\llint/LowLevelInterpreter64.asm:1575
  ...
  _llint_op_catch:
    ...
    cfr.i = *CAST<intptr_t*>(t3.i8p + 16560);                ; ..\..\JavaScriptCore\local\JavaScriptCore\llint/LowLevelInterpreter64.asm:1797
    ...
    t5.i = *CAST<intptr_t*>(t3.i8p + 16576);                 ; ..\..\JavaScriptCore\local\JavaScriptCore\llint/LowLevelInterpreter64.asm:1802
    ...
    t0.i64 = *CAST<int64_t*>(t3.i8p + 16800);                ; ..\..\JavaScriptCore\local\JavaScriptCore\llint/LowLevelInterpreter64.asm:1806
    *CAST<int64_t*>(t3.i8p + 16800) = int64_t(0x0);          ; ..\..\JavaScriptCore\local\JavaScriptCore\llint/LowLevelInterpreter64.asm:1807
    t2.i = *CAST<int32_t*>(pcBase.i8p + (t5.i << 3) + intptr_t(0x8)); ; ..\..\JavaScriptCore\local\JavaScriptCore\llint\LowLevelInterpreter.asm:121
  ...
  _llint_throw_from_slow_path_trampoline:
    ...
    opcode = *CAST<Opcode*>(t1.i8p + 16568);                 ; ..\..\JavaScriptCore\local\JavaScriptCore\llint/LowLevelInterpreter64.asm:1837
    DISPATCH_OPCODE();
  ...
  _llint_op_profile_type:
    ...
    t1.i = *CAST<intptr_t*>(t1.i8p + 16880);                 ; ..\..\JavaScriptCore\local\JavaScriptCore\llint/LowLevelInterpreter64.asm:2193
  ...
  _llint_op_loop_hint:
    ...
    t0.i = *CAST<intptr_t*>(t1.i8p + 9992);                  ; ..\..\JavaScriptCore\local\JavaScriptCore\llint\LowLevelInterpreter.asm:1162
  ...
  _llint_op_call_varargs:
    ...
    if (*CAST<int64_t*>(t3.i8p + 16800) == 0)                ; ..\..\JavaScriptCore\local\JavaScriptCore\llint/LowLevelInterpreter64.asm:584
  ...
  _llint_op_profile_will_call:
    ...
    t0.u = *CAST<uint32_t*>(t0.i8p + 16832);                 ; ..\..\JavaScriptCore\local\JavaScriptCore\llint\LowLevelInterpreter.asm:1312
  ...
  _llint_op_profile_did_call:
    ...
    t0.u = *CAST<uint32_t*>(t0.i8p + 16832);                 ; ..\..\JavaScriptCore\local\JavaScriptCore\llint\LowLevelInterpreter.asm:1323
  ...
  _llint_native_call_trampoline:
    ...
    *CAST<intptr_t*>(t1.i8p + 9984) = cfr.i;                 ; ..\..\JavaScriptCore\local\JavaScriptCore\llint/LowLevelInterpreter64.asm:1881
    ...
    *CAST<intptr_t*>(cfr.i8p + 8) = t3.i;                    ; ..\..\JavaScriptCore\local\JavaScriptCore\llint/LowLevelInterpreter64.asm:1883
    ...
    POP(cfr);                                                ; ..\..\JavaScriptCore\local\JavaScriptCore\llint\LowLevelInterpreter.asm:446
    POP(lr);                                                 ; ..\..\JavaScriptCore\local\JavaScriptCore\llint\LowLevelInterpreter.asm:447
    if (*CAST<int64_t*>(t3.i8p + 16800) != 0)                ; ..\..\JavaScriptCore\local\JavaScriptCore\llint/LowLevelInterpreter64.asm:1902
  ...
  _offlineasm_nativeCallTrampoline__handleException:
    *CAST<intptr_t*>(t3.i8p + 9984) = cfr.i;                 ; ..\..\JavaScriptCore\local\JavaScriptCore\llint/LowLevelInterpreter64.asm:1906
    t2.i = *CAST<intptr_t*>(cfr.i8p + 16);                   ; ..\..\JavaScriptCore\local\JavaScriptCore\llint\LowLevelInterpreter.asm:462
    pc.u = *CAST<uint32_t*>(t2.i8p + 56);                    ; ..\..\JavaScriptCore\local\JavaScriptCore\llint\LowLevelInterpreter.asm:456
    pc.i = pc.i << (intptr_t(0x3) & 0x1f);                   ; ..\..\JavaScriptCore\local\JavaScriptCore\llint\LowLevelInterpreter.asm:457
    pc.i = pc.i + intptr_t(0x0);                             ; ..\..\JavaScriptCore\local\JavaScriptCore\llint\LowLevelInterpreter.asm:458
