...
#  else
#     if defined _WINDLL && !defined CS_UNDEFINED_STRING
...
#  if (defined(CS_UNDEFINED_STRING) && defined(macintosh)) || defined(applec) || \
...
#      if !defined(TARGET_OS_IPHONE) && !defined(TARGET_IPHONE_SIMULATOR) && !defined(TARGET_OS_IPAD) && !defined(TARGET_IPAD_SIMULATOR)
#        include <fp.h>
#      endif
#    endif
#  else
...
#else
//+EAWebKitChange - Compile fix for some platforms.
//1/16/13
#  if 0 /*#ifdef _WINDOWS_ */ /* Favor Windows over C runtime fns */
//-EAWebKitChange
