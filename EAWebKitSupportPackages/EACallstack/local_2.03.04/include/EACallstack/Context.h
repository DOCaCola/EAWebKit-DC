...
/////////////////////////////////////////////////////////////////////////////
// Defines a processor context for various platforms. A processor context
// is the state of all registers and any other pertinent data that defines
// the context of a running thread.
/////////////////////////////////////////////////////////////////////////////

#ifndef EACALLSTACK_CONTEXT_H
#define EACALLSTACK_CONTEXT_H
...
EA_DISABLE_VC_WARNING(4201); // nonstandard extension used: nameless struct/union
...
namespace Callstack
{
	...
	struct CallstackContextBase
	{
		...
		uintptr_t mStackPointer;    /// Pointer to the bottom of the stack

		CallstackContextBase()
			: mStackBase(0)
			, mStackLimit(0)
			, mStackPointer(0)
		{
	...
	struct CallstackContextX86 : public CallstackContextBase
	{
		...
		{
			static constexpr CallstackContextType kType = EA::Callstack::CALLSTACK_CONTEXT_X86;
		};
	...
	struct CallstackContextX86_64 : public CallstackContextBase
	{
		...
		{
			static constexpr CallstackContextType kType = EA::Callstack::CALLSTACK_CONTEXT_X86_64;
		};
	...
	struct CallstackContextARM : public CallstackContextBase
	{
		...
		{
			static constexpr CallstackContextType kType = EA::Callstack::CALLSTACK_CONTEXT_ARM;
		};

	#endif // EA_PROCESSOR_ARM32
	...
	/// address them all. We assume an ARM v7 with VFPv3 here, which is the
	/// latest as of 2010.
	...
	{
		static constexpr CallstackContextType kType = EA::Callstack::CALLSTACK_CONTEXT_ARM64;
	};

	#endif // EA_PROCESSOR_ARM64
	...
	struct ContextARM64
	{
		...
		uint32_t mPadding[2]; // Required to avoid warning 4324 on MSVC
	} EA_POSTFIX_ALIGN(16);
