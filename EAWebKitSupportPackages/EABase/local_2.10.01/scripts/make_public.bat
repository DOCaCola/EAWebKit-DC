...
@SET EABASE_DIR=%OPENSOURCE%\EABase
@SET MASTERCONFIG=%OPENSOURCE%\masterconfig.xml
@SET BUILD_OUT=%EABASE_DIR%\eabase_build_out
@REM =====================================================================================================================================================================
...
@REM =====================================================================================================================================================================
cd %CODESTRIPPER%
call %NANT_EXE% -masterconfigfile:%MASTERCONFIG% -D:codestripper_packages=EABase -D:codestripper_platforms=pc,android,iphone,osx,kettle,capilano -D:codestripper_includesource=true -D:codestripper_outputdir=%STRIPPED%
...
del "%EABASE_DIR%\doc\make_public.bat"
...
@REM ----------------------------------------------------------------------
REM  %CMAKE_BIN%/cmake.exe .. -G "Visual Studio 15 2017 Win64" -DEABASE_BUILD_TESTS:BOOL=ON 
