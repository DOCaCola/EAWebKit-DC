...
#endif
#ifdef EA_PLATFORM_NX // ifdef for code stripping purposes 
 // EA_PLATFORM_NX
#endif
#ifdef EA_PLATFORM_XBSX // ifdef for code stripping purposes 
 // EA_PLATFORM_XBSX
#endif
//    EA_PLATFORM_ANDROID
//    EA_PLATFORM_APPLE
...
// using the MinGW Windows build environment.
	...
	#define EA_PLATFORM_PS5 1
	#define EA_PLATFORM_NAME "PS5"
	#define EA_SYSTEM_LITTLE_ENDIAN 1
	#define EA_PLATFORM_DESCRIPTION "PS5 on x64"
	#define EA_PLATFORM_CONSOLE 1
	#define EA_PLATFORM_SONY 1
	#define EA_PLATFORM_POSIX 1
	// #define EA_POSIX_THREADS_AVAILABLE 1  // POSIX threading API is available but discouraged.  Sony indicated use of the scePthreads* API is preferred. 
...
#elif defined(EA_PLATFORM_XBOXONE) || defined(_DURANGO) || defined(_XBOX_ONE) || defined(EA_PLATFORM_CAPILANO) || defined(_GAMING_XBOX_XBOXONE)
	// XBox One
  ...
  //#define EA_PROCESSOR_X86  Currently our policy is that we don't define this, even though x64 is something of a superset of x86.
	...
	#define EA_WINAPI_FAMILY_PARTITION(Partition)	(Partition)
		...
		#define EA_PLATFORM_GDK 			1
		#define EA_PLATFORM_XBOX_GDK 		1
	#endif

	#if EA_WINAPI_FAMILY_PARTITION(EA_WINAPI_PARTITION_TV_TITLE)
		#define EA_PLATFORM_XBOXONE_XDK 	1
	#endif
#elif defined(EA_PLATFORM_XBSX) || defined(_GAMING_XBOX_SCARLETT)
	...
	#define EA_PLATFORM_NAME "XBox Series X"
	#define EA_PROCESSOR_X86_64 1
	#define EA_SYSTEM_LITTLE_ENDIAN 1
	#define EA_PLATFORM_DESCRIPTION "XBox Series X on x64"
	#define EA_ASM_STYLE_INTEL 1
	#define EA_PLATFORM_CONSOLE 1
	#define EA_PLATFORM_MICROSOFT 1
...
#elif (defined(EA_PLATFORM_WINDOWS) || (defined(_WIN32) || defined(__WIN32__) || defined(_WIN64))) && !defined(_XBOX)
...
// __sparc is defined by the Sun and GCC compilers.
	...
	#define EA_POSIX_THREADS_AVAILABLE 1
		...
		#define EA_PROCESSOR_ARM64
		#define EA_SYSTEM_LITTLE_ENDIAN 1
		#define EA_PLATFORM_DESCRIPTION "NX on ARM64"
    #else
        #define EA_PROCESSOR_ARM32
        #define EA_PROCESSOR_ARM7
		#define EA_SYSTEM_LITTLE_ENDIAN 1
		#define EA_PLATFORM_DESCRIPTION "NX on ARM"
    #endif
