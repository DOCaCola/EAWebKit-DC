...
_cairo_hash_table_create (cairo_hash_keys_equal_func_t keys_equal)
{
    ...
    //+EAWebKitChange
    //01/27/14
    hash_table = cairo_malloc (sizeof (cairo_hash_table_t));
    //-EAWebKitChange
...
//+EAWebKitChange
//1/27/2014
    hash_table->entries = cairo_calloc (*hash_table->table_size,
...
//+EAWebKitChange
//1/27/2014
    tmp.entries = cairo_calloc (new_size, sizeof (cairo_hash_entry_t*));
//-EAWebKitChange
