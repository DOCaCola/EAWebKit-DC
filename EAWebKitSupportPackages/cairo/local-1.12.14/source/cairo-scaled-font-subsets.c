			      ...
			      int          	utf8_len)
{
    ...
    //+EAWebKitChange
    //01/27/14
    sub_font_glyph = cairo_malloc (sizeof (cairo_sub_font_glyph_t));
    //-EAWebKitChange
...
_cairo_sub_font_glyph_destroy (cairo_sub_font_glyph_t *sub_font_glyph)
{
    //+EAWebKitChange
    //01/27/14
    cairo_free (sub_font_glyph->utf8);
    //-EAWebKitChange

    //+EAWebKitChange
    //01/27/14
    cairo_free (sub_font_glyph);
    //-EAWebKitChange
}
			...
			cairo_sub_font_t               **sub_font_out)
{
    ...
    //+EAWebKitChange
    //01/27/14
    sub_font = cairo_malloc (sizeof (cairo_sub_font_t));
    //-EAWebKitChange
    ...
    *is_mapped = FALSE;
	...
	if (sub_font_glyph->utf8 != NULL) {
		...
		*is_mapped = TRUE;
	    ...
	    //+EAWebKitChange
	    //01/27/14
	    sub_font_glyph->utf8 = cairo_malloc (utf8_len + 1);
	    //-EAWebKitChange
                           ...
                           cairo_scaled_font_subsets_glyph_t *subset_glyph)
{
	...
	if (text_utf8 != NULL && text_utf8_len > 0) {
		...
		if (ucs4_len == 1) {
		    ...
		    //+EAWebKitChange
		    //01/27/14
		    cairo_free (font_utf8);
		    //-EAWebKitChange
		    //+EAWebKitChange
		    //01/27/14
		    font_utf8 = cairo_malloc (text_utf8_len + 1);
		    //-EAWebKitChange
		    if (font_utf8 == NULL) {
			//+EAWebKitChange
			//01/27/14
...
_cairo_sub_font_collect (void *entry, void *closure)
{
	...
	if (subset.glyph_names != NULL) {
		...
		//+EAWebKitChange
		//01/27/14
		cairo_free (subset.glyph_names[j]);
		//-EAWebKitChange
	    //+EAWebKitChange
	    //01/27/14
	    cairo_free (subset.glyph_names);
	    //-EAWebKitChange
	}
...
_cairo_scaled_font_subsets_create_internal (cairo_subsets_type_t type)
{
    ...
    //+EAWebKitChange
    //01/27/14
    subsets = cairo_malloc (sizeof (cairo_scaled_font_subsets_t));
    //-EAWebKitChange
					     ...
					     cairo_subsets_foreach_type_t	       type)
{
	...
	//+EAWebKitChange
	//01/27/14
	cairo_free (collection.glyphs);
	//-EAWebKitChange
	//+EAWebKitChange
	//01/27/14
	cairo_free (collection.utf8);
	//-EAWebKitChange
	//+EAWebKitChange
	//01/27/14
	cairo_free (collection.to_latin_char);
	//-EAWebKitChange
	//+EAWebKitChange
	//01/27/14
	cairo_free (collection.latin_to_subset_glyph_index);
	//-EAWebKitChange
...
create_string_entry (char *s, cairo_string_entry_t **entry)
{
    //+EAWebKitChange
    //01/27/14
    *entry = cairo_malloc (sizeof (cairo_string_entry_t));
    //-EAWebKitChange
...
_cairo_scaled_font_subset_create_glyph_names (cairo_scaled_font_subset_t *subset)
{
    ...
    //+EAWebKitChange
    //01/27/14
    subset->glyph_names = cairo_calloc (subset->num_glyphs, sizeof (char *));
    //-EAWebKitChange
...
CLEANUP_HASH:
	...
	for (i = 0; i < subset->num_glyphs; i++) {
	    //+EAWebKitChange
	    //01/27/14
	    cairo_free (subset->glyph_names[i]);
	    //-EAWebKitChange
	}
