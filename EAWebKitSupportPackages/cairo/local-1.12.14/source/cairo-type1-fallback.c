                         ...
                         cairo_bool_t                 hex_encode)
{
    ...
    //+EAWebKitChange
    //01/27/14
    font = cairo_calloc (1, sizeof (cairo_type1_font_t));
    //-EAWebKitChange
    ...
    //+EAWebKitChange
    //01/27/14
    font->widths = cairo_calloc (scaled_font_subset->num_glyphs, sizeof (int));
    //-EAWebKitChange
                                     ...
                                     cairo_bool_t                hex_encode)
{
    ...
    //+EAWebKitChange
    //01/27/14
    type1_subset->widths = cairo_calloc (sizeof (double), font->scaled_font_subset->num_glyphs);
    //-EAWebKitChange
                               ...
                               cairo_scaled_font_subset_t *scaled_font_subset)
{
    ...
    //+EAWebKitChange
    //01/27/14
    type2_subset->widths = cairo_calloc (sizeof (int), font->scaled_font_subset->num_glyphs);
    //-EAWebKitChange
...
_cairo_type2_charstrings_fini (cairo_type2_charstrings_t *type2_subset)
{
    ...
    //+EAWebKitChange
    //01/27/14
    cairo_free (type2_subset->widths);
    //-EAWebKitChange
}
