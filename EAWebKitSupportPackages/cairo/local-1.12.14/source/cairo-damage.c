...
_cairo_damage_create (void)
{
    ...
    //+EAWebKitChange
    //01/27/14
    damage = cairo_malloc (sizeof (*damage));
    //-EAWebKitChange
			...
			int count)
{
    ...
    //+EAWebKitChange
    //01/27/14
    chunk = cairo_malloc (sizeof (*chunk) + sizeof (cairo_box_t) * size);
    //-EAWebKitChange
...
_cairo_damage_reduce (cairo_damage_t *damage)
{
	...
	//+EAWebKitChange
	//01/27/14
	boxes = free_boxes = cairo_malloc (damage->dirty * sizeof (cairo_box_t));
	//-EAWebKitChange
