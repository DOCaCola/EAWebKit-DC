...
bbtree_new (const cairo_box_t *box, cairo_command_header_t *chain)
{
    //+EAWebKitChange
    //01/27/14
    struct bbtree *bbt = cairo_malloc (sizeof (*bbt));
    //-EAWebKitChange
    if (bbt == NULL)
	return NULL;
    bbt->extents = *box;
				...
				const cairo_rectangle_t	*extents)
{
    ...
    //+EAWebKitChange
    //01/27/14
    surface = cairo_malloc (sizeof (cairo_recording_surface_t));
    //-EAWebKitChange
...
_cairo_recording_surface_finish (void *abstract_surface)
{
	...
	case CAIRO_COMMAND_SHOW_TEXT_GLYPHS:
	    ...
	    //+EAWebKitChange
	    //01/27/14
	    cairo_free (command->show_text_glyphs.utf8);
	    //-EAWebKitChange
	    //+EAWebKitChange
	    //01/27/14
	    cairo_free (command->show_text_glyphs.glyphs);
	    //-EAWebKitChange
	    //+EAWebKitChange
	    //01/27/14
	    cairo_free (command->show_text_glyphs.clusters);
	    //-EAWebKitChange
	      ...
	      cairo_surface_t *image)
{
    ...
    //+EAWebKitChange
    //01/27/14
    proxy = cairo_malloc (sizeof (*proxy));
    //-EAWebKitChange
				...
				const cairo_clip_t	  *clip)
{
    ...
    //+EAWebKitChange
    //01/27/14
    command = cairo_malloc (sizeof (cairo_command_paint_t));
    //-EAWebKitChange
			       ...
			       const cairo_clip_t	*clip)
{
    ...
    //+EAWebKitChange
    //01/27/14
    command = cairo_malloc (sizeof (cairo_command_mask_t));
    //-EAWebKitChange
    if (unlikely (command == NULL)) {
	status = _cairo_error (CAIRO_STATUS_NO_MEMORY);
	goto CLEANUP_COMPOSITE;
				 ...
				 const cairo_clip_t	*clip)
{
    ...
    //+EAWebKitChange
    //01/27/14
    command = cairo_malloc (sizeof (cairo_command_stroke_t));
    //-EAWebKitChange
    if (unlikely (command == NULL)) {
	status = _cairo_error (CAIRO_STATUS_NO_MEMORY);
	goto CLEANUP_COMPOSITE;
			       ...
			       const cairo_clip_t	*clip)
{
    ...
    //+EAWebKitChange
    //01/27/14
    command = cairo_malloc (sizeof (cairo_command_fill_t));
    //-EAWebKitChange
    if (unlikely (command == NULL)) {
	status = _cairo_error (CAIRO_STATUS_NO_MEMORY);
	goto CLEANUP_COMPOSITE;
					   ...
					   const cairo_clip_t		*clip)
{
    ...
    //+EAWebKitChange
    //01/27/14
    command = cairo_malloc (sizeof (cairo_command_show_text_glyphs_t));
    //-EAWebKitChange
    if (unlikely (command == NULL)) {
	status = _cairo_error (CAIRO_STATUS_NO_MEMORY);
	goto CLEANUP_COMPOSITE;
	...
	//+EAWebKitChange
	//01/27/14
	command->utf8 = cairo_malloc (utf8_len);
	//-EAWebKitChange
  ...
  CLEANUP_ARRAYS:
    //+EAWebKitChange
    //01/27/14
    cairo_free (command->utf8);
    //-EAWebKitChange
    //+EAWebKitChange
    //01/27/14
    cairo_free (command->glyphs);
    //-EAWebKitChange
    //+EAWebKitChange
    //01/27/14
    cairo_free (command->clusters);
    //-EAWebKitChange
				      ...
				      const cairo_command_t *src)
{
    ...
    //+EAWebKitChange
    //01/27/14
    command = cairo_malloc (sizeof (*command));
    //-EAWebKitChange
    if (unlikely (command == NULL)) {
	status = _cairo_error (CAIRO_STATUS_NO_MEMORY);
	goto err;
				       ...
				       const cairo_command_t *src)
{
	...
	//+EAWebKitChange
	//01/27/14
	command->utf8 = cairo_malloc (command->utf8_len);
	//-EAWebKitChange
	if (unlikely (command->utf8 == NULL)) {
	    status = _cairo_error (CAIRO_STATUS_NO_MEMORY);
	    goto err_arrays;
