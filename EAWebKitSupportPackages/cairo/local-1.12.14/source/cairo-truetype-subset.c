			     ...
			     cairo_truetype_font_t      **font_return)
{
    ...
    //+EAWebKitChange
    //01/27/14
    font = cairo_malloc (sizeof (cairo_truetype_font_t));
    //-EAWebKitChange
    ...
    //+EAWebKitChange
    //01/27/14
    font->glyphs = cairo_calloc (font->num_glyphs_in_face + 1, sizeof (subset_glyph_t));
    //-EAWebKitChange
    ...
    //+EAWebKitChange
    //01/27/14
    font->parent_to_subset = cairo_calloc (font->num_glyphs_in_face, sizeof (int));
    //-EAWebKitChange
    ...
    if (font->base.ps_name == NULL) {
        //+EAWebKitChange
        //01/27/14
        font->base.ps_name = cairo_malloc (30);
        //-EAWebKitChange
    ...
    //+EAWebKitChange
    //01/27/14
    font->base.widths = cairo_calloc (font->num_glyphs_in_face, sizeof (int));
    //-EAWebKitChange
 ...
 fail5:
    ...
    //+EAWebKitChange
    //01/27/14
    cairo_free (font->base.widths);
    //-EAWebKitChange
 fail4:
    //+EAWebKitChange
    //01/27/14
    cairo_free (font->base.ps_name);
    //-EAWebKitChange
 fail3:
    //+EAWebKitChange
    //01/27/14
    cairo_free (font->parent_to_subset);
    //-EAWebKitChange
    //+EAWebKitChange
    //01/27/14
    cairo_free (font->base.font_name);
    //-EAWebKitChange
 fail2:
    //+EAWebKitChange
    //01/27/14
    cairo_free (font->glyphs);
    //-EAWebKitChange
 fail1:
				      ...
				      cairo_bool_t                is_pdf)
{
    ...
    //+EAWebKitChange
    //01/27/14
    truetype_subset->widths = cairo_calloc (sizeof (double),
    //-EAWebKitChange
	...
	//+EAWebKitChange
	//01/27/14
	truetype_subset->data = cairo_malloc (length);
	//-EAWebKitChange
	...
	//+EAWebKitChange
	//01/27/14
	truetype_subset->string_offsets = cairo_malloc (offsets_length);
	//-EAWebKitChange
 ...
 fail5:
    //+EAWebKitChange
    //01/27/14
    cairo_free (truetype_subset->data);
    //-EAWebKitChange
 fail4:
    //+EAWebKitChange
    //01/27/14
    cairo_free (truetype_subset->widths);
    //-EAWebKitChange
 fail3:
    //+EAWebKitChange
    //01/27/14
    cairo_free (truetype_subset->family_name_utf8);
    //-EAWebKitChange
 fail2:
    //+EAWebKitChange
    //01/27/14
    cairo_free (truetype_subset->ps_name);
    //-EAWebKitChange
 fail1:
    cairo_truetype_font_destroy (font);
...
_cairo_truetype_subset_fini (cairo_truetype_subset_t *subset)
{
    ...
    //+EAWebKitChange
    //01/27/14
    cairo_free (subset->string_offsets);
    //-EAWebKitChange
}
...
find_name (tt_name_t *name, int name_id, int platform, int encoding, int language, char **str_out)
{
	...
	if (be16_to_cpu (record->name) == name_id &&
	    ...
	    //+EAWebKitChange
	    //01/27/14
	    str = cairo_malloc (be16_to_cpu (record->length) + 1);
	    //-EAWebKitChange
	    if (str == NULL)
		return _cairo_error (CAIRO_STATUS_NO_MEMORY);
