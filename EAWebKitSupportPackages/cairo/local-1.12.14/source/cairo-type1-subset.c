...
cairo_type1_font_subset_decrypt_eexec_segment (cairo_type1_font_subset_t *font)
{
    ...
    //+EAWebKitChange
    //01/27/14
    font->cleartext = cairo_malloc (font->eexec_segment_size + 1);
    //-EAWebKitChange
					  ...
					  int                        encrypted_charstring_length)
{
    ...
    //+EAWebKitChange
    //01/27/14
    charstring = cairo_malloc (encrypted_charstring_length);
    //-EAWebKitChange
					    ...
					    const char                *name)
{
    ...
    if ((lenIV_start = find_token (font->cleartext, font->cleartext_end, "/lenIV")) != NULL) {
        ...
        //+EAWebKitChange
        //01/27/14
        lenIV_str = cairo_malloc (lenIV_end - lenIV_start + 1);
        //-EAWebKitChange
    ...
    //+EAWebKitChange
    //01/27/14
    font->subrs = cairo_calloc (font->num_subrs, sizeof (font->subrs[0]));
    //-EAWebKitChange
...
skip_subrs:
    ...
    //+EAWebKitChange
    //01/27/14
    font->subset_index_to_glyphs = cairo_calloc (font->base.num_glyphs, sizeof font->subset_index_to_glyphs[0]);
    //-EAWebKitChange
...

{
    ...
    //+EAWebKitChange
    //01/27/14
    font->type1_data = cairo_malloc (font->type1_length);
    //-EAWebKitChange
...
_cairo_type1_font_subset_fini (cairo_type1_font_subset_t *font)
{
    ...
    //+EAWebKitChange
    //01/27/14
    cairo_free (font->base.base_font);
    //-EAWebKitChange

    //+EAWebKitChange
    //01/27/14
    cairo_free (font->subset_index_to_glyphs);
    //-EAWebKitChange

    //+EAWebKitChange
    //01/27/14
    cairo_free (font->cleartext);
    //-EAWebKitChange
                          ...
                          cairo_bool_t                   hex_encode)
{
    ...
    //+EAWebKitChange
    //01/27/14
    type1_subset->widths = cairo_calloc (sizeof (double), font.num_glyphs);
    //-EAWebKitChange
    ...
    //+EAWebKitChange
    //01/27/14
    type1_subset->data = cairo_malloc (length);
    //-EAWebKitChange
 ...
 fail3:
    //+EAWebKitChange
    //01/27/14
    cairo_free (type1_subset->widths);
    //-EAWebKitChange
 fail2:
    //+EAWebKitChange
    //01/27/14
    cairo_free (type1_subset->base_font);
    //-EAWebKitChange
 fail1:
