...
_cairo_clip_path_create (cairo_clip_t *clip)
{
	...
	//+EAWebKitChange
	//01/27/14
	clip_path = cairo_malloc (sizeof (cairo_clip_path_t));
	//-EAWebKitChange
	if (unlikely (clip_path == NULL))
	    return NULL;
    }
...
_cairo_clip_create (void)
{
	...
	//+EAWebKitChange
	//01/27/14
	clip = cairo_malloc (sizeof (cairo_clip_t));
	//-EAWebKitChange
	if (unlikely (clip == NULL))
	    return NULL;
    }
...
#define ERROR_LIST(S) _cairo_rectangle_list_create_in_error (_cairo_error (S))
 ...
 DONE:
    //+EAWebKitChange
    //01/27/14
    list = cairo_malloc (sizeof (cairo_rectangle_list_t));
    //-EAWebKitChange
    if (unlikely (list == NULL)) {
        //+EAWebKitChange
        //01/27/14
...
cairo_rectangle_list_destroy (cairo_rectangle_list_t *rectangle_list)
{
    ...
    //+EAWebKitChange
    //01/27/14
    cairo_free (rectangle_list->rectangles);
    //-EAWebKitChange
    //+EAWebKitChange
    //01/27/14
    cairo_free (rectangle_list);
    //-EAWebKitChange
}
