			    ...
			    const cairo_pattern_t  *other)
{
	...
	//+EAWebKitChange
	//01/27/14
	pattern = cairo_malloc (sizeof (cairo_solid_pattern_t));
	//-EAWebKitChange
	break;
    case CAIRO_PATTERN_TYPE_SURFACE:
	//+EAWebKitChange
	//01/27/14
	pattern = cairo_malloc (sizeof (cairo_surface_pattern_t));
	//-EAWebKitChange
	break;
    case CAIRO_PATTERN_TYPE_LINEAR:
	//+EAWebKitChange
	//01/27/14
	pattern = cairo_malloc (sizeof (cairo_linear_pattern_t));
	//-EAWebKitChange
	break;
    case CAIRO_PATTERN_TYPE_RADIAL:
	//+EAWebKitChange
	//01/27/14
	pattern = cairo_malloc (sizeof (cairo_radial_pattern_t));
	//-EAWebKitChange
	break;
    case CAIRO_PATTERN_TYPE_MESH:
	//+EAWebKitChange
	//01/27/14
	pattern = cairo_malloc (sizeof (cairo_mesh_pattern_t));
	//-EAWebKitChange
	break;
    case CAIRO_PATTERN_TYPE_RASTER_SOURCE:
	//+EAWebKitChange
	//01/27/14
	pattern = cairo_malloc (sizeof (cairo_raster_source_pattern_t));
	//-EAWebKitChange
	break;
    default:
	ASSERT_NOT_REACHED;
