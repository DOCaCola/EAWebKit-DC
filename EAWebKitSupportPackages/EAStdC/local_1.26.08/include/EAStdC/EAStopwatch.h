	...
	#include <time.h>
		...
		inline uint64_t EA::StdC::Stopwatch::GetCPUCycle()
		{
			...
			if(result == EINVAL 
					...
					// Nintendo customized the API to return -1 if 'CLOCK_REALTIME' is not passed.
					// https://developer.nintendo.com/html/online-docs/nx-en/g1kr9vj6-en/document.html?doc=Packages/SDK/NintendoSDK/Documents/Package/contents/Pages/Page_165351275.html
					|| result == -1
				#endif
				)
