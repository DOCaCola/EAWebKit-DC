...
EAWebKit has dependencies on additonal third party libraries: Cairo, FreeType, libJPEG, libPNG, libxml2, Pixman, SQLite and zlib.  The licenses for these products are covered under the following documents:
...
* License libXML.txt -- License for xml processing.
